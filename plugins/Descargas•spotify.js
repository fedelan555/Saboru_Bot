...
ര ׄ🍀 Título      : » ${track.name}
ര ׄ🍀 Artista     : » ${track.artists.map((a) => a.name).join(", ")}
ര ׄ🍀 Álbum       : » ${track.album.name}
ര ׄ🍀 Fecha       : » ${track.album.release_date}
ര ׄ🍀 Popularidad : » ${track.popularity}/100
ര ׄ🍀 Duración    : » ${(track.duration_ms / 60000).toFixed(2)} min
ര ׄ🍀 ISRC        : » ${track.external_ids?.isrc || "No disponible"}
ര ׄ🍀 URL         : » ${track.external_urls.spotify}
